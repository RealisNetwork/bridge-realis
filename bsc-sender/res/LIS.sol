...
contract StandartToken is BEP20, BasicToken{
...
contract Ownable {
    ...
    address internal masterKey = 0x6D1eee1CFeEAb71A4d7Fcc73f0EF67A9CA2cD943;
...
contract LISToken is MultisendableToken {

    event Burn(address indexed _from, uint256 _value);
    event Mint(address indexed _to, uint256 _value);
    event Transfer(address indexed from, address indexed to, uint256 value);

    string constant public name = "LISToken";
    string constant public symbol = "LIS";
    uint constant public decimals = 18;

    uint256 constant public START_TOKENS = 500000000 * 6 * 10**decimals; //500M start
